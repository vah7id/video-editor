  ...
  return (
    <>
      ...
      <div className="widescreen:min-h-screen container mx-auto flex flex-col justify-center">
        ...
        <Image src={logo1} style={{cursor: 'pointer',position: 'relative',marginBottom: '-32px !important',minWidth: '200px', margin: '0 auto'}} alt="video trimmer compressor tool logo" />
