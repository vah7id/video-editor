            ...
            <div className="text-center motion-safe:animate-fly-2">
              ...
              <label
                ...
                className={classNames(
                  "inline-block mt-16 relative px-5 py-3 text-2xl rounded-3xl bg-red-900 hover:bg-red-800 shadow-lg shadow-red-900/30 text-white text-xl cursor-pointer peer-focus:ring",
