  ...
  return (
    <>
      ...
      <div className="widescreen:min-h-screen container mx-auto flex flex-col justify-center">
        ...
        <Image src={logo1} style={{cursor: 'pointer',position: 'relative',float: 'left',minWidth: '200px', margin: '0 auto -32px auto !important'}} alt="video trimmer compressor tool logo" />
