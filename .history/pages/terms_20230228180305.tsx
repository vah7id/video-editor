...
<br /><br />
Refunds<br /><br />
Please, review the refund policy and test the free version of our service thoroughly before purchasing a subscription.

Viddeo users are themselves responsible for managing their subscriptions and cancellations.

If you have purchased an annual or a lifetime subscription and changed your mind, let us know within the first month and we will be able to refund you the prorated amount.

Viddeo users have unlimited access to their projects as long as their subscription is active, but since this feature is still under testing, there is no guarantee that your projects will actually be stored in an unlimited amount for an unlimited period of time. You are responsible for making regular backup copies of your projects to avoid losing them, as we are not a cloud storage service.

Be aware that we do not issue refunds in the following cases:
<br /><br />
You dont like the service.
...
Youre dissatisfied with the features provided by our service or you havent found some particular features.
Youve found another service that you like better.
You didnt cancel your subscription before the automatic renewal happened.
Youre dissatisfied with the speed while uploading a file from or downloading a file to your local device. Please be aware that uploading and downloading speed is out of our scope, it depends only on the upload and download bandwidth of your internet connection or upload and download capabilities of your internet service provider (ISP). Our hosts are located in Germany and you may use https://speedtest.net/ to check your upload and download bandwidth to any German host. Contact your ISP for further assistance. To speed up the uploading or downloading process you can upload a file from or download a file to Google Drive or Dropbox instead of your local device.
Youre dissatisfied with video editing speed. In some cases, video processing may take more time because it requires a full reencode of a video stream that is needed in order to achieve better quality. Please also note, that the time needed to process a Full HD video may be as long as half of the actual video duration. You can reduce the video processing time by submitting a video with a lower resolution.
Youre trying to edit a corrupted file that couldnt be opened even by its native application. We try our best to perform the editing even in the most hopeless cases but if the file is not readable at all (e.g., because of a missing header or moov atom in the video file) — there is nothing we can do at all.
If you still believe that you have a good reason for a refund, please contact our support team and specify at least the following:
<br /><br />
the reason why you claim the refund;
...
The Company may assign or delegate these Terms of Service and/or the Companys Privacy Policy, in whole or in part, to any person or entity at any time with or without your consent. You may not assign or delegate any rights or obligations under the Terms of Service or Privacy Policy without the Company's prior written consent, and any unauthorized assignment and delegation by you is void.
