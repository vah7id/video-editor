        ...
        >
          ...
          <div className="flex-auto p-2 lg:py-16 max-w-full lg:max-w-lg">
            ...
            <div className="mb-2 motion-safe:animate-fly-2">
              <label style={{ height: '36px', float: 'left', width: '100%'}} htmlFor="video_format">
                Select {t("conversion.video_quality.label")}:
              </label>
              <Controller
                control={control}
                name="video"
            ...
            {!watch("video")?.codec.startsWith("gif") && (
              <div className="my-2 mt-2 motion-safe:animate-fly-3">
                <label  style={{ height: '36px', marginTop: '12px', float: 'left', width: '100%'}} htmlFor="audio_format">
      ...
      >
        ...
        <div className="flex flex-row items-baseline gap-2 motion-safe:animate-fly-3">
          <Button
            href={src}
            download={file.name}
            className="table px-4 py-2  bg-red-800 hover:bg-red-700 text-white"
          >
