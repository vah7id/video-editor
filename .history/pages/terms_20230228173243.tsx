...
We may also use your email address, to send you other messages, including information about the Company and special offers. You may opt out of such email by changing your account settings or sending an email to Softo Limited.
...
Clideo users are themselves responsible for managing their subscriptions and cancellations.
...
You're trying to edit a corrupted file that couldnt be opened even by its native application. We try our best to perform the editing even in the most hopeless cases but if the file is not readable at all (e.g., because of a missing header or moov atom in the video file) — there is nothing we can do at all.
If you still believe that you have a good reason for a refund, please contact our support team (https://help.clideo.com/hc/en-us/requests/new) and specify at least the following:
