  ...
  return (
    <>
      ...
      <div className="widescreen:min-h-screen container mx-auto flex flex-col justify-center">
        ...
        <Image src={logo1} style={{cursor: 'pointer',display: 'block',position: 'relative',float: 'left',minWidth: '200px', margin: '0 auto 0px auto !important'}} alt="video trimmer compressor tool logo" />
        ...
        >
          ...
          <div style={{marginTop: '-40px !important'}} className="flex-grow px-4 motion-safe:animate-fly-5">
          ...
          <div className="flex-auto p-2 lg:py-16 max-w-full lg:max-w-lg">
            ...
            <div className="flex gap-2 mt-8 motion-safe:animate-fly-4">
              <Button
                type="submit"
                className="px-4 py-2  bg-red-800 hover:bg-red-700 text-white"
              >
