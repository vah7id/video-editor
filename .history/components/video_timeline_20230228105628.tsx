  ...
  return (
    <div className={classNames("flex flex-col font-mono", className)}>
      ...
      <div className="flex flex-row my-2 gap-2">
        <Button
          className="w-16 h-16  text-white rounded-l-2xl"
          onClick={togglePlay}
        >
...
function SegmentInputs({
  ...
  return (
    <div className="flex flex-row justify-between bg-black text-secondary">
      <div>
...
>) {
  ...
  return (
    <div className="flex-grow h-16 bg-neutral-900 relative select-none touch-none">
