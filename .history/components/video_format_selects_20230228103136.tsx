...
const selectStyles = {
  ...
  classNames: {
    control: ({ isFocused }) =>
      classNames(
        "px-4 py-2  border bg-white text-neutral-800 dark:bg-neutral-800 dark:text-white",
        { ring: isFocused }
      ),
    menu: () =>
      "my-2 py-2  overflow-hidden border shadow-xl fly-in bg-white text-neutral-800 dark:bg-neutral-800 dark:text-white",
