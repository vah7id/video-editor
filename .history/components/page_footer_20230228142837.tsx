...
export function Page_footer() {
  ...
  return (
    <div className="mt-2  pb-8 bg-slate-50print:min-h-0" style={{maxWidth:'768px',  margin: '0 auto'}}>
      <footer>
        <ul style={{textTransform: 'uppercase', color: '#ccc', fontSize: '13px', width: '100%', float: 'left'}}>
          <li>
            <Link href={'/'}>Home</Link>
          </li>
          <li>
