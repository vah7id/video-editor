    ...
    <div className="mt-2  pb-8 bg-slate-50print:min-h-0" style={{maxWidth:'768px', display: 'block',  textAlign: 'center', margin: '0 auto'}}>
      <footer>
        <ul style={{textTransform: 'uppercase', textAlign: 'center', color: '#cacaca'}}>
          ...
          <li>
            <Link href={'/'}>Audio Remover From Video</Link>
          </li>
        </ul>
...
online video editor /
        ...
        <p style={{width: '100%', fontSize: '10px !important', color: '#fafafa'}}>
        Online Video Cutter: This web app comes in handy when you need to cut a small video file. It does not require installation, and it works in your browser. Crop video: Cropping allows you to frame the video to the desired area or change frame proportions.
        </p>
        <p style={{width: '100%', fontSize: '10px !important', color: '#fafafa'}}>
